...
. Other providers (notably Gemini) emit call IDs
 ...
 *   String should match pattern '^[a-zA-Z0-9_-]+content: (LanguageModelTextPart | LanguageModelToolResultPart | LanguageModelToolCallPart | LanguageModelDataPart | LanguageModelThinkingPart)[]): ContentBlockParam[] {
